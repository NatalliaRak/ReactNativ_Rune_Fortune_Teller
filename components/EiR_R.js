    ...
    return(
        <View style={styles.container}>
            ...
            />
                ...
                <Text style={styles.runeTells}>Гэтая руна ў адваротным палажэнні. Руна гаворыць пра неспакой, прагу пераменаў, недавер, дысгармонію</Text>
        </View>
    )
};
