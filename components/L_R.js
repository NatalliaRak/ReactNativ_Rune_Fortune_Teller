    ...
    return(
        <View style={styles.container}>
            ...
            />
                ...
                <Text style={styles.runeTells}> Руна ў адваротным палажэнні. Руна гаворыць пра страх, няправільную ацэнку сітуацыі, адсутнасць крэатыўнасці, пазбяганне рэчаіснасці
                </Text>
        </View>
    )
};
