    ...
    return(
        <View style={styles.container}>
            ...
            />
                ...
                <Text style={styles.runeTells}> Руна ў прамым палажэнні. Яна гавораць пра прасвятленне, веды, разуменне, пранікненне, асвятленне, пакліканне, мэту, ідэю.
                </Text>
        </View>
    )
};

export default KaunaR;