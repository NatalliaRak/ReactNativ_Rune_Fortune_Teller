    ...
    return(
        <View style={styles.container}>
            ...
            />
                ...
                <Text style={styles.runeTells}>Руна ў адваротным палажэнні. Руна гаворыць пра безабароннасць, прымус, злосць, здраду
                </Text>
        </View>
    )
};

export default ThR_R;